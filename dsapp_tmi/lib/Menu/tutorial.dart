    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: ListView(children: <Widget>[
            ...
            Text(
                '2. Comenzar: Para empezar a usar la aplicación, activara la cámara para detectar los objetos. En la parte inferior de la ventana hay un boton para realizar una foto, si en dicha foto se reconoce un texto, este se mostrara por pantalla y audio.\n',
                style: TextStyle(fontSize: 17)),
            Text(
